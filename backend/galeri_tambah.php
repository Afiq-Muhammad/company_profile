<section class="section">
    <div class="container-fluid">
        ...
        <div class="card col-md-6">
            <div class="card-body">
                <form action="?page=galeri_tambah_proses" method="post" autocomplete="off" enctype="multipart/form-data">
                    <div class="input-style-1">
                        <label>Foto</label>
                        <input type="file" class="form-control" accept=".jpeg, .png, .jpg" name="foto" id="foto" onchange="checkFileSize()">
                        <p class="text-danger">Ukuran file maksimal 100Kb</p>
                    </div>
                    <div class="input-style-1">
                        <label for="judul">Judul Galeri</label>
                        <input type="text" class="form-control" name="judul" placeholder="Judul Galeri" id="judul">
                    </div>
                    <div class="input-style-1">
                        <label for="sinopsis">Sinopsis Galeri</label>
                        <input type="text" class="form-control" name="sinopsis" placeholder="Sinopsis Galeri" id="sinopsis">
                    </div>
                    <div class="input-style-1">
