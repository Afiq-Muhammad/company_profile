...
<section class="section">
    <div class="container-fluid">
        ...
        <div class="card col-md-6">
            <div class="card-body">
                <form action="?page=galeri_ubah_proses" method="post" autocomplete="off" enctype="multipart/form-data">
                    <input type="hidden" class="form-control" name="id" placeholder="Kode Produk" value="<?= $pro['id'] ?>">
                    <div class="input-style-1">
                        <label for="judul">Judul Galeri</label>
                        <input type="text" value="<?= $pro['judul'] ?>" class="form-control" name="judul" placeholder="Judul Galeri" id="judul" required>
                    </div>
                    <div class="input-style-1">
                        <label for="sinopsis">Sinopsis Galeri</label>
                        <input type="text" value="<?= $pro['sinopsis'] ?>" class="form-control" name="sinopsis" placeholder="Sinopsis Galeri" id="sinopsis" required>
                    </div>
                    <div class="input-style-1">
                    ...
                    <div class="input-style-1">
                        ...
                        <div style="display: flex; align-items: center;">
                            <img src="img/galeri/<?= $pro['foto']; ?>" width="100" class="rounded-3 mb-10" id="currentImage">
                        ...
                        <p class="text-danger">Ukuran file maksimal 100 Kb</p>
                    </div>
